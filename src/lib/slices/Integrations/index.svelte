...
<Bounded data-slice-type={slice.slice_type} data-slice-variation={slice.variation} class="relative overflow-hidden">
	...
	<div class="relative">
		<h2 class="mx-auto max-w-2xl text-balance bg-gradient-to-b from-violet-50 to-violet-300 
	...
	<div class="flex flex-col mt-20 items-center md:flex-row">
		{#each slice.items as item, index}
			...
			{/if}
		<div class="pulsing-icon flex aspect-square shrink-0 items-center 
		justify-center rounded-full border border-violet-50/30 bg-violet-50/25 p-3 text-3xl 
		text-violet-100 opacity-40 md:text-3xl lg:text-5xl">
